...
const featureSlides = [
  ...
  },
  {
    ...
    list: [
      '점자 블록 및 점자 손잡이 설치 현황',
      '출입구 자동문 및 안내견 동반 가능 여부',
      '안내 요원 배치 및 음성안내 서비스',
      '음성안내 어플리케이션 지원 유무',
    ],
  },
  {
    ...
    reverse: false,
    h3: '소통의 장벽을 넘어',
    desc: '청각장애인도 편안하게 여행할 수 있도록 다양한 소통 지원 시설을 안내합니다. 수어 안내 서비스부터 문자 정보 제공, 시각적 안내 시설까지. 여행지의 편의시설 정보를 미리 확인하세요.',
    list: [
      '수어 안내 서비스 (안내데스크 등)',
      '문자 안내 서비스 (전광판, 안내 책자)',
      '시각 경보 장치 (비상상황 대응)',
